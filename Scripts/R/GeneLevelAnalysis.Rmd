...
# Save plots
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/GenePCA.svg",plot = p_gene_pca, width = 6, height = 5)
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/PathPCA.svg",plot = p_path_pca, width = 6, height = 5)
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/PathCovPCA.svg",plot = p_pathCov_pca, width = 6, height = 5)
```
...
# Save plots
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/GenePCA_study.svg",plot = p_gene_pca_study, width = 6, height = 5)
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/PathPCA_study.svg",plot = p_path_pca_study, width = 6, height = 5)
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/PathCovPCA_study.svg",plot = p_pathCov_pca_study, width = 6, height = 5)
```
...
# Save plots
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/GenePCA_study.svg",plot = p_gene_UMAP, width = 6, height = 5)
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/PathPCA_study.svg",plot = p_path_UMAP, width = 6, height = 5)
ggsave(filename = "~/Documents/PhD/Gut-microbiome-immunotherapy/Figures/GenePath/PathCovPCA_study.svg",plot = p_pathCov_UMAP, width = 6, height = 5)
...
# Create annotations for pathway heatmap
hm.cols = data.frame(Response = gsub(".*_R","R",gsub(".*_NR","NR",colnames(pathAbundance))))
hm.cols$Response = factor(hm.cols$Response,levels(hm.cols$Response)[c(2,1)])
rownames(hm.cols) = colnames(pathAbundance)
# Create heatmap
# type "?pheatmap()" for more help
# CairoWin()
pheatmap(pathAbundance[rownames(DEpaths),],
         kmeans_k = NA,
         show_rownames = TRUE, show_colnames = TRUE,
         main = "Differentially abundant genes, log-normalised CoPM",
         clustering_method = "average",
...
Let's try Lasso regression as well, which performs both variable selection and model fitting.
```{r}
